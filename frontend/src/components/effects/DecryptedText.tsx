...
export const DecryptedText: React.FC<DecryptedTextProps> = ({
  ...
  }, [loop, isAnimating, isDecrypted, loopInterval, triggerDecrypt]);
  ...
  return (
    <motion.span className={parentClassName} ref={containerRef} style={styles.wrapper} {...animateProps} {...props}>
      ...
      <span aria-hidden="true" style={{ display: 'inline-flex', alignItems: 'center', lineHeight: 'inherit' }}>
          ...
          return (
            <span
              ...
              style={{
                ...
                textAlign: 'center',
                width: isSpace ? '0.35em' : '1ch',
                minWidth: isSpace ? '0.35em' : '1ch',
